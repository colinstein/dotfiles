...
alias ll='gls --group-directories-first --color=auto --classify --literal --human-readable --si -l'
...
alias la='gls --group-directories-first --color=auto --classify --literal --human-readable --si -A'
